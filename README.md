...
nuget pack ./src/Package.Template.nuspec -NoDefaultExcludes -OutputDirectory ./out -Version 2.1.1

# Install the template locally
dotnet new install ./out/Genocs.Library.Template.2.1.1.nupkg
...
> **Latest Version**: The current stable version is **2.1.1**. Check [NuGet](https://www.nuget.org/packages/Genocs.Library.Template/) for the latest release.
