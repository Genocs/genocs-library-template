...
nuget pack ./src/Package.Template.nuspec -NoDefaultExcludes -OutputDirectory ./out -Version 2.2.0

# Install the template locally
dotnet new install ./out/Genocs.Library.Template.2.2.0.nupkg
...
> **Latest Version**: The current stable version is **2.2.0**. Check [NuGet](https://www.nuget.org/packages/Genocs.Library.Template/) for the latest release.
